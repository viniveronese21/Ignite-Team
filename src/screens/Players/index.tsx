...
import { playersAddByGroupAndTeam } from "@storage/players/playerGetByGroupAndTeam";
...
export function Players() {
  ...
  async function fetchPlayersByTeam() {
    try {
      setIsLoading(true);
      const playersByTeam = await playersAddByGroupAndTeam(group, team);
  ...
  async function handleGroupRemove() {
    Alert.alert("Rmover", "Deseja remover a turma", [
